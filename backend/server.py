...
async def call_gemini(prompt: str) -> str:
    """
    Call Google Gemini 1.5 Flash — 100% FREE.
...
{{"title":"...","target_calories":1800,"season":"{ritu['key']}","season_name":"{ritu['name']}","notes":"Prakriti and seasonal reasoning...","meals":[{{"day":1,"breakfast":{{"time":"7:00 AM","items":["item (portion)"],"calories":300,"ayurvedic_note":"..."}},"mid_morning":{{"time":"10:00 AM","items":["item"],"calories":100,"ayurvedic_note":"..."}},"lunch":{{"time":"12:30 PM","items":["item1","item2"],"calories":500,"ayurvedic_note":"..."}},"evening_snack":{{"time":"4:00 PM","items":["item"],"calories":150,"ayurvedic_note":"..."}},"dinner":{{"time":"7:00 PM","items":["item1","item2"],"calories":400,"ayurvedic_note":"..."}}}}]}}"""
    try:
        diet_plan = json.loads(await call_gemini(prompt))
        cid = str(uuid.uuid4()); now = datetime.now(timezone.utc).isoformat()
...
{{"overall_rating":"good","summary":"2-3 sentence overall assessment","gaps":[{{"nutrient":"Iron","current_estimate":"~8mg/day","recommended":"{rda['iron_mg']}mg/day","status":"low","severity":"moderate","ayurvedic_alternatives":["Sesame seeds","Fenugreek leaves","Amla","Dates"],"modern_alternatives":["Spinach","Lentils","Fortified cereals"],"explanation":"Why this matters..."}}],"strengths":["Good protein from moong dal"],"recommendations":["Add 1 tbsp sesame seeds to breakfast"],"ayurvedic_note":"Ayurvedic perspective..."}}"""
    try:
        analysis = json.loads(await call_gemini(prompt))
...
async def seed_foods_database():
    ...
    foods=[
        ...
        {"name":"Moong Dal","name_hindi":"मूंग दाल","category":"Lentils","calories":347,"protein_g":24,"carbs_g":63,"fat_g":1.2,"fiber_g":16,"rasa":["Sweet","Astringent"],"virya":"Cold","vipaka":"Sweet","guna":["Light","Soft"],"dosha_effect":{"vata":"neutral","pitta":"decreases","kapha":"decreases"},"is_vegetarian":True,"is_vegan":True,"is_gluten_free":True},
        {"name":"Toor Dal","name_hindi":"तूर दाल","category":"Lentils","calories":343,"protein_g":22,"carbs_g":63,"fat_g":1.5,"fiber_g":15,"rasa":["Sweet","Astringent"],"virya":"Hot","vipaka":"Sweet","guna":["Light"],"dosha_effect":{"vata":"neutral","pitta":"neutral","kapha":"decreases"},"is_vegetarian":True,"is_vegan":True,"is_gluten_free":True},
        ...
        {"name":"Amla","name_hindi":"आंवला","category":"Herbs","calories":44,"protein_g":0.9,"carbs_g":10.2,"fat_g":0.6,"fiber_g":4.3,"rasa":["Sour","Sweet","Pungent","Bitter","Astringent"],"virya":"Cold","vipaka":"Sweet","guna":["Light","Dry"],"dosha_effect":{"vata":"decreases","pitta":"decreases","kapha":"decreases"},"vitamin_c_mg":600,"is_vegetarian":True,"is_vegan":True,"is_gluten_free":True},
        {"name":"Milk (Cow)","name_hindi":"गाय का दूध","category":"Dairy","calories":61,"protein_g":3.2,"carbs_g":4.8,"fat_g":3.3,"fiber_g":0,"rasa":["Sweet"],"virya":"Cold","vipaka":"Sweet","guna":["Heavy","Oily","Smooth"],"dosha_effect":{"vata":"decreases","pitta":"decreases","kapha":"increases"},"calcium_mg":119,"is_vegetarian":True,"is_vegan":False,"is_gluten_free":True},
        {"name":"Ghee","name_hindi":"घी","category":"Dairy","calories":900,"protein_g":0,"carbs_g":0,"fat_g":100,"fiber_g":0,"rasa":["Sweet"],"virya":"Cold","vipaka":"Sweet","guna":["Heavy","Oily","Smooth"],"dosha_effect":{"vata":"decreases","pitta":"decreases","kapha":"increases"},"is_vegetarian":True,"is_vegan":False,"is_gluten_free":True},
        {"name":"Paneer","name_hindi":"पनीर","category":"Dairy","calories":265,"protein_g":18,"carbs_g":1.2,"fat_g":21,"fiber_g":0,"rasa":["Sweet","Sour"],"virya":"Cold","vipaka":"Sweet","guna":["Heavy","Smooth"],"dosha_effect":{"vata":"decreases","pitta":"decreases","kapha":"increases"},"calcium_mg":208,"is_vegetarian":True,"is_vegan":False,"is_gluten_free":True},
        ...
        {"name":"Sesame Seeds","name_hindi":"तिल","category":"Seeds","calories":573,"protein_g":17.7,"carbs_g":23.5,"fat_g":49.7,"fiber_g":11.8,"rasa":["Sweet","Bitter","Astringent"],"virya":"Hot","vipaka":"Sweet","guna":["Heavy","Oily"],"dosha_effect":{"vata":"decreases","pitta":"increases","kapha":"increases"},"calcium_mg":975,"iron_mg":14.5,"is_vegetarian":True,"is_vegan":True,"is_gluten_free":True},
        {"name":"Almonds","name_hindi":"बादाम","category":"Nuts","calories":579,"protein_g":21,"carbs_g":22,"fat_g":50,"fiber_g":12.5,"rasa":["Sweet"],"virya":"Hot","vipaka":"Sweet","guna":["Heavy","Oily"],"dosha_effect":{"vata":"decreases","pitta":"increases","kapha":"increases"},"calcium_mg":269,"is_vegetarian":True,"is_vegan":True,"is_gluten_free":True},
